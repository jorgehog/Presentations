...
\newcommand*{\mytitle}{Coupling Molecular Dynamics\\ and Quantum Mechanics\\ \vspace{0.25cm} \scriptsize{A (hopefully) lightweight introduction to a not so lightweight topic.}} % Title
...
\begin{itemize}
 \item Integrate Newton's equations for a dynamic ensemble of point particles.
...
%------------------------------------------------
The force is expressed as the gradient of the potential
...
\subsection{Difference from Statistical Mechanics}
\clearpage

%------------------------------------------------

\subsection{Benefits and Problems}
\cite{H_He_Exact}
\clearpage
